...
import (
	...
	sqlc "github.com/mohammad19khodaei/simple_bank/db/sqlc"
...
func (m *MockStore) GetAccount(ctx context.Context, id int32) (sqlc.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountForUpdate(ctx context.Context, id int32) (sqlc.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetEntry(ctx context.Context, id int32) (sqlc.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfer(ctx context.Context, id int32) (sqlc.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) TransferTx(ctx context.Context, params sqlc.TransferTxParams) (sqlc.TransferTxResult, error) {
	m.ctrl.T.Helper()
